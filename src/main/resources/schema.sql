...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2022 a las 14:13:00
...
INSERT INTO `autors` (`id`, `image`, `name`, `surnames`) VALUES
                                                             (1, NULL, 'Vi', 'Keeland'),
                                                             (2, NULL, 'Ali', 'Hazelwood'),
                                                             (3, NULL, 'Alissa', 'Brontë'),
                                                             (4, NULL, 'Raquel', 'Antúnez'),
                                                             (5, NULL, 'Whitney', 'G'),
                                                             (6, NULL, 'Yanira', 'García'),
                                                             (7, NULL, 'Lina', 'Galán'),
                                                             (8, NULL, 'Max', 'Monroe'),
                                                             (9, NULL, 'Elena', 'García'),
                                                             (10, NULL, 'Maria José', 'Tirado');
...
INSERT INTO `editorials` (`id`, `image`, `name`) VALUES
                                                     (1, 'https://i.imgur.com/DOTtnKf.jpg', 'Roca Editorial'),
                                                     (2, 'https://i.imgur.com/K17MU2D.jpg', 'Contraluz'),
                                                     (3, 'https://i.imgur.com/Dyr9LeZ.jpg', 'Autopublicado'),
                                                     (4, 'https://i.imgur.com/ifDLvyE.png', 'Phoebe'),
                                                     (5, 'https://i.imgur.com/NeSIXQl.jpg', 'Zafiro'),
                                                     (6, 'https://i.imgur.com/o1L6xWW.jpg', 'Nova Casa');
...
INSERT INTO `img` (`id`, `name`, `type`) VALUES
                                             ...
                                             (2, 'la_hiptesis_del_amor.png', 'image/png'),
                                             (3, 'mi_vida_k-drama.png', 'image/png'),
                                             (4, 'veinte_motivos_para_olvidarte_del_amor.png', 'image/png'),
                                             (5, 'te_esperar_todas_las_noches.png', 'image/png'),
                                             (6, 'lnea_ertica_dgame.png', 'image/png'),
                                             (7, 'demasiado_perfecto.png', 'image/png'),
                                             (8, 'el_billonario.png', 'image/png'),
                                             (9, 'la_manguera_que_nos_uni.png', 'image/png'),
                                             (10, 'mi_propio_turco_de_telenovela.png', 'image/png'),
                                             (11, 'un_error_maravilloso.png', 'image/png'),
                                             (12, 'la_hiptesis_del_amor.png', 'image/png'),
                                             (13, 'mi_vida_k-drama.png', 'image/png'),
                                             (14, 'veinte_motivos_para_olvidarte_del_amor.png', 'image/png'),
                                             (15, 'te_esperar_todas_las_noches.png', 'image/png'),
                                             (16, 'lnea_ertica_dgame.png', 'image/png'),
                                             (17, 'demasiado_perfecto.png', 'image/png'),
                                             (18, 'el_billonario.png', 'image/png'),
                                             (19, 'la_manguera_que_nos_uni.png', 'image/png'),
...
INSERT INTO `users` (`id`, `email`, `name`, `password`, `register_date`, `surnames`, `username`, `image_id`) VALUES
    (1, 'matamor98@hotmail.com', 'Santiago', '$2a$10$eDlNbDVp6jJN0SaNU9ItgOs2rDXMfCequI8qkyPGE.GxzzNc0STey', '2022-05-25 13:11:12.195000', 'González Londoño', 'matamor', 21);
...
--
-- AUTO_INCREMENT de la tabla `books_series`
--
ALTER TABLE `books_series`
